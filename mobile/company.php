...
<section>
    ...
    <div class="companyCont">
        ...
        <p class="companyText">私たちが提供している商品は、形のある物ではなく、 安全、安心、信頼、迅速、好感、快適、清潔といった形のないサービスです。 それだからこそ、お客様からの信頼感が最も重要であり、 信頼感を得るために一番大切にしている財産は「人間力のある社員」と「良いビジネスパートナー」です。 まだまだ小さな会社ですが、そのことを忘れず「大きな希望」を持って、 目標に向かって日々仕事に取り組んでおります。</p>
    ...
    <div class="companyCont">
    	<ul class="enkaku">
        	<li>
                ...
                <p class="article">資本金10,000千円をもって設立、取締役社長に関利彦氏就任</p>
            </li>
        	<li>
        	...
        	<li>
                ...
                <p class="article">取締役社長に村松修氏就任</p>
            </li>
        	<li>
        	...
        	<li>
                ...
                <p class="article">取締役社長に斉藤薫氏就任</p>
            </li>
        	<li>
            	<p class="date">2002年7月1日</p>
                <p class="article">遠鉄グループ事業再編により株式会社遠鉄総合ビルサービス（現・遠鉄建設）から建物管理部門と清掃部門を営業譲受</p>
            </li>
        	<li>
        	...
        	<li>
                ...
                <p class="article">取締役社長に内山芳実氏就任</p>
            </li>
        	<li>
