      ...
      <footer id="Footer">
        ...
        <div
          ...
          <div>
            ...
            <li> 　受託業務情報</li>
            <li>　・運行管理サービス事業、指定管理サービス事業、ビル管理・清掃事業、食品検査事業、マンション管理事業、生活支援サービス事業の事務処理のため。</li>
          ...
          <div>
            <h5><strong>お問い合わせへの返信・ご連絡について</strong></h5>
                フォームからお問い合せをいただいた際、まず自動返信の受付メールを、ご登録いただいたお客様のメールアドレス宛にお送りします。<br />
                その後、改めてお問い合せに回答をいたします。お問い合せの内容によっては、電話など、メール以外の方法で連絡を差し上げる場合がございますので、ご了承ください。<br />
                また、ご記入いただいたメールアドレスに誤りがある場合や、システム障害・通信障害などのトラブルにより、メールでの回答を差し上げられない場合がございます。<br />
                ご登録のメールアドレスにメールが届かなかった場合などは、再度フォームからお問い合わせいただくか、お電話にてご連絡をお願いいたします。<br /><br />
                受付時間外（18時00分〜翌9時00分 および土・日・祝日・年末年始）にいただいたお問い合せにつきましては、原則翌営業日以降に連絡いたします。<br />
                当社から回答いたしました内容は、お客様個人に宛てたものです。回答メールの内容の一部または全部を当社へのお問い合せ以外に転用することは、固くお断りいたします。 <br />
                <h5><strong>お問い合せ内容について</strong></h5>
                商品セールスなど、営業目的の内容を送信することは、固くお断りいたします。
              </div>
            ...
            <p>
                <strong>【個人情報に関するお問い合わせ先】</strong><br />
                 遠鉄アシスト株式会社　総務課<br />
                 〒430-0927  静岡県浜松市中区旭町12-1<br />
                 電話番号：053-450-1511<br />
                 メール　：assist-privacy＠entetsu.co.jp
            </p>
