    ...
    return (
      <article id="DrivingDetail" className="pf-Detail">
        ...
        <section>
          ...
          <div className="effect">
            <h3>遠鉄グループ輸送部門の実績とノウハウ、運転サービス士の確かな安全技術、<br />
              笑顔の接客・接遇で、多くのお客様から信頼をいただいております。</h3>
            
            <strong>地元に根付いた遠鉄グループだから出来ること</strong>
            <p>
              母体が遠州鉄道株式会社だからこそ、70年以上の旅客運送のノウハウの蓄積を生かし、安全運転のための運転士研修、健康管理体制を取っており、サービス向上のための接客接遇教育を欠かしておりません。 また、グループ各社の総合力を結集し、給油・整備・自動車保険・万が一の事故対応まで、お客様へ安心と満足をお届けする体制をとっております。
            </p>
          </div>
        </section>
        ...
        <section className="odd">
          ...
          <div className="effect">
            ...
            <strong>役員車</strong>
            <p>車両の点検、整備、清掃を入念に行い、当日のスケジュールを事前にきちんと把握した上で、支社回り、取引先との会合・会談が行われる目的地へ安全に運行し、ご自宅や宿泊先までお見送りいたします。業務後は車両の点検を行い、報告書を提出します。</p>
            ...
            <strong>病院</strong>
            <p>運転サービス士が施設へ出勤し、車両の点検、整備、清掃を行います。担当の方と一緒に当日送迎サービスが必要な利用者様を確認し、それぞれのご自宅までお迎えに上がります。走行中や車いす乗降リフト操作は、利用者様の心身に負担がかからないよう安全運転を励行し、帰宅時も同様に移動をサポートいたします。</p>

            <strong>ホテル・飲食店</strong>
            <p>運転サービス士がお店へ出勤し、車両の点検、整備、清掃を行います。再度、場所と人数を確認し、お迎え先へ向かいます。お店まで安全運転で快適にお送りします。お帰りの際は車内の清潔や空調を整えてお客様をお迎えし、飲酒後のお客様に配慮した、穏やかなハンドル操作で安全にお送りします。</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="effect">
            ...
            <p>
              安全運行の実施と接客サービスの向上を目的として、定期的に年２回の運転士の研修会を実施しております。 もしも事故やクレームがあった場合には、運転士全員で情報を共有し、技術･マナー･意識の見直しをさせていきます。
            </p>
...
text: '企業の役員様に安全で快適な運行サービスをお届けいたします。運転士にはもちろん運転技術だけでなく、お客様へのマナー、守秘義務の徹底等、ハイレベルな教育を施して運行を行います。',
},

{

title: '通学の送迎だけでなく、部活動の遠征などにも幅広く対応いたします',
text: '貴校の大切な生徒様を、安全･確実に学校までお送りいたします。通学も学校生活の一部です。快適に学校に通うためには、運転サービス士の人柄や決め細やかなサービスも大切な要素だと考え、たくさんの思い出を一緒に作りあげていきたいと思います。',
},

{
title: '園児も先生も保護者様も、みなさま笑顔の安全運行',
text: '元気いっぱいの園児の皆さんは、明るい未来の象徴です。大切な命をお預かりするためにも、運転サービス士に対して徹底した技術指導・健康管理を指導。明るい笑顔と挨拶で、安心安全な運行はもちろんの事保護者様にも地域のみなさまにも配慮したサービスを提供いたします。',
},
{
...
text: 'これからお仕事に向かわれるお客様のモチベーションを保つように安全・快適な運転をご提供いたします。通勤車両の駐車スペースを確保しなくても済み、時間に沿った運行を行いますので、御社の効率化・コストダウンに効果的な業務を行います。また、御社のお車での研修時送迎などのご要望にも対応できます。',
},

{
title: '大切な時間を守り、お店までしっかり安全運転を励行します',
text: '冠婚葬祭、さまざまなシーンに対応した運行を、お客様にご提供いたします。お客様を安心・安全な運行で御社までお届けする事が、更なる付加価値を高める重要な要素だと考えます。',
},

{
title: 'どんなときでも安定した運行業務を提供いたします',
text: '特別職公用車の運行から、地域のコミュニティーバスの運行まで。地域に根ざした遠鉄グループの弊社だからこそできる運行に携わらせていただきます。',
},
]
