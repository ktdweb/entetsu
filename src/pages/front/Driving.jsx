...
title: '園児も先生も保護者様も、みなさま笑顔の安全運行',
  text: '元気いっぱいの園児の皆さんは、明るい未来の象徴です。<br />大切な命をお預かりするためにも、運転サービス士に対して徹底した技術指導・健康管理を指導。<br />明るい笑顔と挨拶で、安心安全な運行はもちろんの事保護者様にも、<br />地域のみなさまにも配慮したサービスを提供いたします。',
},
{
...
title: '大切な時間を守り、お店まで安全運転を励行します',
  text: '冠婚葬祭、さまざまなシーンに対応した運行を、お客様にご提供いたします。<br />お客様を安心・安全な運行で御社までお届けする事が、<br />更なる付加価値を高める重要な要素だと考えます。',
},
