      ...
      <article id="DrivingDetail" className="pf-Detail">
        ...
        <section className="odd">
          ...
          <div className="effect">
            ...
            <strong>役員車</strong>
            <p>車両の点検、整備、清掃を入念に行い、ご指定の時間に役員車を回送。運転士がドアを開けてお迎えし、座席シートへご案内します。当日のスケジュールを事前にきちんと把握した上で、支社回り、取引先との会合・会談が行われる目的地へ安全に運行し、ご自宅または宿泊先のホテルの玄関でお見送りいたします。業務後は車両の点検を行い、報告書を提出します。</p>

            <strong>スクールバス</strong>
            <p>車両の点検、整備、清掃を入念に行い、運行コースと停車場所を確認。生徒のみなさんの通学時間に合わせて車両を回送し、元気な挨拶と笑顔で乗車を待ちます。みなさんが着席したのを確認して発車し、安全かつ穏やかな運転を励行します。下校時も同様に対応し、挨拶を徹底して生徒の健全育成をサポート。課外授業や部活の遠征も承ります。</p>

            <strong>病院</strong>
            <p>運転士が施設へ出勤し、車両の点検、整備、清掃を行います。担当の方と一緒に当日送迎サービスが必要な利用者様を確認し、それぞれのご自宅までお迎えに上がります。ご自宅では福祉車両の車椅子乗降リフトを操作し、お部屋から車まで移動のお手伝いをいたします。心身に負担がかからないよう安全運転を励行し、帰宅時も同様に移動をサポートいたします。</p>

            <strong>ホテル・飲食店</strong>
            <p>運転士がホテルへ出勤し、車両の点検、整備、清掃を行います。再度、場所と人数を確認し、お迎え場所へ向かいます。お客様を笑顔でお迎えし、シートベルト着用を見届けて、ホテルまで安全運転でお送りします。お帰りの際は車内の清潔や空調を整えてお客様をお迎えし、飲酒後のお客様の気分が悪くならないよう、穏やかなハンドル操作で安全にお送りします。</p>
          </div>
        </section>
