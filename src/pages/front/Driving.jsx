      ...
      <article id="DrivingDetail" className="pf-Detail">
        ...
        <section>
          ...
          <div className="effect">
            ...
            <p>
              母体が遠州鉄道株式会社だからこそ、70年以上の旅客運送のノウハウの蓄積を生かし、安全運転のための運転サービス士研修、健康管理体制を取っており、サービス向上のための接客接遇教育を欠かしておりません。 また、グループ各社の総合力を結集し、給油・整備・自動車保険・万が一の事故対応まで、お客様へ安心と満足をお届けする体制をとっております。
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="effect">
            ...
            <p>
              遠鉄グループのノウハウを活かし、安全・安心・快適の管理を行っています。遠州鉄道株式会社が行う旅客運送事業のノウハウを生かし、他社より一歩進んだ管理を行なっております。 運転サービス士は出勤時には必ずアルコールのチェックを行い、月に一度は健康状態を確認しております。また、ご相談頂ければ、車両にドライブレコーダーを搭載させていただき、リアルタイムでの勤務状態の確認、万が一の事故の際の記録等を行っております。
            </p>
          </div>
        </section>
      </article>
...
text: '企業の役員様に安全で快適な運行サービスをお届けいたします。運転サービス士にはもちろん運転技術だけでなく、お客様へのマナー、守秘義務の徹底等、ハイレベルな教育を施して運行を行います。',
},
...
text: '患者様には必要不可欠な移動手段です。ご負担をかけないように、真心を込めて業務を行い、快適な乗車時間のご提供に努めます。',
},
