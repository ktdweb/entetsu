      ...
      <article id="CleaningDetail" className="pf-Detail">
        ...
        <section className="odd">
          ...
          <div className="effect">
            ...
            <strong>日常清掃</strong>
              <p>店舗、事務所内、共用スペース、トイレなど日常的に使用する場所を継続して清掃をすることにより美観や清潔さを維持することを目的としております。</p>

            <strong>定期清掃</strong>
              <p>日常清掃では、落としきれない汚れを除去することを目的としております。例えば、定期的に床面洗浄及びワックスを塗布することで、床を保護して汚れをつきにくくするなどのメリットなどがあります。他にもガラス清掃、カーペットクリーニングなど建物の状態、お客様のご要望にあわせ、最適なプランをご提案させていただきます。</p>

            <strong>人材育成</strong>
              <p>弊社では、2016年6月よりお客様に「美」を感じていただけるよう、個々の清掃技術、知識の向上を図る目的として、トレーニングセンターを開設いたしました。清掃未経験の方でも、当社の指導員がベットメイク、トイレや水廻りの清掃等を基礎から丁寧に指導していきます。</p>

            <strong>サービスの標準化</strong>
              <p>弊社は、高い清掃品質を全てのお客様に提供できるよう作業方法、作業手順、使用する清掃資機材のマニュアルを作成し、清掃品質が一様になるようにつとめています。トイレ、洗面台、床等、適切な作業道具またはクロス、モップなどの清掃道具を色分けすることで、衛生面に配慮し、清潔な清掃をいたします。</p>

            <strong>より良いサービスの提供</strong>
              <p>弊社は、清掃品質がより良くなるように作業方法・手順の改善点やより良い清掃資機材がないか見直しをする為、定期的にミーティングを実施しております。</p>
          </div>
        </section>
...
title: '美しく衛生的な居住環境を実現',
  text: '美観を維持し、清潔で快適な環境を整えるために、敷地内外や建物、<br />設備などの共用部分の清掃を日常的または定期的に行います。',
},

{
title: '美しく、心が潤う植栽環境を維持します',
  text: '植栽は建物の価値とイメージを向上させる重要な要素です。<br />周囲の景観との調和を考え、見た目に美しく、心身をリラックスさせる植栽管理で<br />建物の印象アップに貢献します。',
},

{
title: 'いつも清潔な客室をスピーディーに整えます',
  text: 'ネット検索サイトの「清潔項目」で高評価をいただき、ホテルから表彰されるなど、<br />ベッドメイキングの実績は豊富。お客様の満足を第一に、<br />清潔な客室をスピーディーに整えます。',
},

{
title: 'ニーズに合わせてフレキシブルに対応します',
  text: '分譲マンション・賃貸アパート・戸建住宅と、建物の構造に精通したスタッフが、<br />隅々まで配慮した安心のハウスクリーニング・リフォーム・リノベーションを提供いたします。',
},
]
